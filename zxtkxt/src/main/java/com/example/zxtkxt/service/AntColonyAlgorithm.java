...
public class AntColonyAlgorithm {
    ...
    private double pheromoneDecay = 0.7; // 信息素挥发系数
...
//            //提前结束
//            if (paperTemplate.getDifficulty()-finallyDifficulty<0.1){
//                System.out.println("提前结束");
//                break;
//            }
       ...
       //该题型的试题数量
        ...
        for (int i = 0; i < numOfQuestions; i++) {
            ...
            if (!contains(selectedQuestions, i)) {
                ...
                if(selectedNum==0){
                   pheromoneLevel = pheromone[selectedNum][i];
                }else {
                    pheromoneLevel = pheromone[selectedQuestions[selectedNum-1]][i];
                }
